...
import 'package:my_flutter_mall/common/get/get_dialog_extension.dart';
...
import 'package:my_flutter_mall/model/request_result.dart';
    ...
    HttpRequest.request(method, url, parameters, isJson: isJson, success: (result) {
      ...
      if (success != null) {
        ...
        if (resultModel.errno == 0) {
          ...
          ///其他状态，弹出错误提示信息
          ToastUtils.show(resultModel.errmsg);
        }
      }
    }, fail: (code, msg) {
      if (dialog) {
